...
from herbarium.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from herbarium.config import instantiate, LazyCall
...
_CFG_PACKAGE_NAME = "herbarium._cfg_loader"
"""
