...
def setup_logger(
    output=None, distributed_rank=0, *, color=True, name="herbarium", abbrev_name=None
):
    """
...
def _log_api_usage(identifier: str):
    """
    Internal function used to log the usage of different herbarium components
    inside facebook's infra.
    """
    torch._C._log_api_usage_once("herbarium." + identifier)
