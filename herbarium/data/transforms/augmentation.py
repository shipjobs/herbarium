...
https://herbarium.readthedocs.io/tutorials/augmentation.html
"""
...
class Augmentation:
    ...
    def get_transform(self, *args) -> Transform:
        ...
        Notes:
            ...
            input data. In herbarium we use the following convention:
            ...
            * sem_seg: (H,W) ndarray of type uint8. Each element is an integer label of pixel.
            ...
            :class:`Augmentation` that uses other types in herbarium.
        """
