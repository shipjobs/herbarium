...
It is an entry point that is made to train standard models in herbarium.
...
Therefore, we recommend you to use herbarium as an library and take
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["herb"]:
            evaluator_list.append(HERBEvaluator(dataset_name, output_dir=output_folder))
